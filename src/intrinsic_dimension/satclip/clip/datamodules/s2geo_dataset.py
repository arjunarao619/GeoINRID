...
from .transforms import get_pretrained_s2_train_transform, get_s2_train_transform,  get_rcf_s2_train_transform
...
class S2GeoDataModule(pl.LightningDataModule):
    def __init__(
        ...
        elif transform=='rcf_transform':
            self.train_transform = get_rcf_s2_train_transform()
        else:
    ...
    def prepare_data(self) -> None:
        if not os.path.exists(self.data_dir):
            print("""
            no dataset found. Please download with:
            ...
            mkdir geoclip_s2
            cd geoclip_s2
            azcopy copy --recursive "https://researchlabwusstorage.blob.core.windows.net/torchgeo-datasets/geoclip?sv=2021-10-04&st=2023-07-25T15%3A44%3A12Z&se=2030-07-26T15%3A44%3A00Z&sr=c&sp=rl&sig=%2Fz3XB3JCTbT77lkZ9i60esK6TSzJL1yM6kO%2Bem4HiuU%3D" .
            """)
